...
export default function AdminDashboard() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <Sidebar style={{ zIndex: 1300, position: 'fixed' }} />
      <Box sx={{ flexGrow: 1, ml: `${drawerWidth}px`, zIndex: 1, position: 'relative' }}>
        <AppBar position="fixed" open={open}>
          <Toolbar>
            ...
            <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1, color: '#0E86A9' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center' }} onClick={handleLogout}>

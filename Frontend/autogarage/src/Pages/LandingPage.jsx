...
const LandingPage = () => {
    ...
    const handleAdminLoginClick = () => {
        navigate('/adminreg'); // Navigate to the admin login page
    };
        ...
        <div>
            ...
            <div>
                <div className="container">
                    ...
                    <p className="text" style={{marginTop: '15vh', backgroundColor:'#222222', padding: '10px', cursor: 'pointer', borderRadius: '10px'}} onClick={handleAdminLoginClick}>Admin Login</p>
                </div>
                <section>
